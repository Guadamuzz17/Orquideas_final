...
export default function Formato() {
  const handleDownloadFormat = () => {
    ...
    // Por ejemplo, generar un PDF o descargar un archivo Excel
    console.log('Descargando formato de juzgamiento...');
    
    // Simulación de descarga - puedes reemplazar esto con tu lógica real
    const link = document.createElement('a');
    link.href = '/path-to-your-format-file.pdf'; // Reemplaza con la ruta real
    link.download = 'formato-juzgamiento-orquideas.pdf';
            ...
            <Card className="col-span-full">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="rounded-lg border-2 border-dashed border-blue-200 p-6 text-center">
                  ...
                  <h4 className="text-lg font-semibold mb-2">Descargar Formato</h4>
                  <p className="text-gray-600 mb-4">
                    Descarga el formato oficial en PDF para el juzgamiento de orquídeas
                  </p>
                  <Button 
