...
export default function EditEvento({ evento }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route('eventos.update', evento.id_evento));
  };
        ...
        <div>
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <li>
                <BreadcrumbPage>Editar Evento</BreadcrumbPage>
              </li>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div className="max-w-2xl mx-auto w-full">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Actualice los datos del evento
              </CardDescription>
            </CardHeader>
            <CardContent>
